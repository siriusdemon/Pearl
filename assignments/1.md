...
+ [Notes](./acker.scm) on recursive functions for repeated addition/multiplication/exponentiation/etc.
+ [Simplification](./ackermann.scm) of the Ackermann function to standard form.
