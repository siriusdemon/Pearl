...
These are not at all required reading, but for a wider understanding of what we're doing, see <a href="../material/Definitional interpreters for higher-order programming languages.pdf">Reynolds</a> and Danvy.
```racket
> (value-of
   '((lambda (x) (if (zero? x)
                     #t
