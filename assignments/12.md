...
You should use the monads.rkt file provided in lecture notes. You should add it to your C311 directory. This contains all the monad definitions you should need.
